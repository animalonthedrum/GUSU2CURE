function visitUserPage( UserInfoService, userPageService, adminService) {
    var vm = this;
    console.log('this user');
    vm.checkForUserSearched = function() {
        UserInfoService.seeOtherUsersPage().then(function() {
            vm.thisUser = UserInfoService.thisUserSaved;
            console.log('vm.thisUser', vm.thisUser);
        });//end of promise
